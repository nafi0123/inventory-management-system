...
const Sidebar = ({ isOpen, setIsOpen }: SidebarProps) => {
  ...
  const activeClass =
    "bg-[#f9db3d] text-black font-bold shadow-sm scale-[1.02]";
  const normalClass =
    "text-gray-500 hover:bg-gray-50 hover:text-black transition-all duration-300";
  
  // Submenu active style logic
              ...
              <div className="mt-1 ml-4 space-y-1 border-l-2 border-gray-100 pl-2">
                <Link
                  ...
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl text-sm transition-all ${
                    pathname === "/stock/products" ? subActive : subNormal
                  }`}
                >
                  <Package size={16} />
                  Products
                ...
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl text-sm transition-all ${
                    pathname === "/stock/categories" ? subActive : subNormal
                  }`}
                >
                  <Layers size={16} />
                  Categories
            ...
            {openMenu === "customers" && (
              <div className="mt-1 ml-4 space-y-1 border-l-2 border-gray-100 pl-2">
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl text-sm transition-all ${
                    pathname === "/dashboard/customers/all" ? subActive : subNormal
                  }`}
                >
                  <Users size={16} />
                  All Customers
                ...
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl text-sm transition-all ${
                    pathname === "/dashboard/customers/add" ? subActive : subNormal
                  }`}
                >
                  <UserPlus size={16} />
                  Add Customer
            ...
            {openMenu === "settings" && (
              <div className="mt-1 ml-4 space-y-1 border-l-2 border-gray-100 pl-2">
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                  className={`flex items-center gap-3 px-6 py-3 rounded-xl text-sm transition-all ${
                    pathname === "/settings/profile" ? subActive : subNormal
                  }`}
                >
